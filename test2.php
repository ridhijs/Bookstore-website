...
{
    echo "username exist please enter other name";
	
    }
else {
    $sql = "INSERT INTO users(username,pswd,emailid,mobile,address)
VALUES ('$username1', '$password1', '$email', '$mob','$address')";

if ($conn->query($sql) === TRUE) {
    echo "New record created successfully";$_SESSION['currentuser']=$username1;
} else {
...
<a href="index.php" >continue shoping</a> ;
  ...
  <!-- Footer -->
  <div id="footer">
    <p class="left"> <a href="index.php">Home</a> <span>|</span> <a href="support.html">Support</a> <span>|</span> <a href="account">My Account</a> <span>|</span> <a href="contact.php">Contact Us</a> </p>
