...
?></strong></span> </div>
  ...
  <div id="main">
    ...
    <div id="content">
	  ...
	  <!-- Products -->
      <div class="products">
	  <h1>BEST ROMANTIC BOOKS</h1><br/>
        <div class="cl">&nbsp;</div>
        <ul>
          <li> <a href="#"><img src="css/images/Romantic/betme.jpg" alt="" /></a>
            <div class="product-info">
              <h3>BET ME</h3>
              <div class="product-desc">
                <h4>JENNIFER CRUSIE'S</h4>
                <p>BET ME<br />
                 </p>
                <strong class="price">Rs.499.00</strong> </div>
            </div>
          </li>
          <li> <a href="#"><img src="css/images/Romantic/blackice.jpg" alt="" /></a>
            <div class="product-info">
              <h3>BLACK ICE</h3>
              <div class="product-desc">
                <h4>ANNE STUART'S</h4>
          ...
          <li class="last"> <a href="#"><img src="css/images/Romantic/fifty.jpg" alt="" /></a>
            <div class="product-info">
              <h3>50 SHADES OF GREY</h3>
              <div class="product-desc">
                <h4>E.L.JAMES</h4>
                <p>50 SHADES OF GREY<br />
                </p>
		...
		<ul>
		 <li> <a href="#"><img src="css/images/Romantic/flower.jpg" alt="" /></a>
            <div class="product-info">
              <h3>FLOWERS FROM THE STORM</h3>
              <div class="product-desc">
                <h4>LAURA KINSALE'S</h4>
                <p>FLOWERS FROM THE STORM<br />	
                </p>
                <strong class="price">Rs.999.00</strong> </div>
            </div>
          </li>
		   <li> <a href="#"><img src="css/images/Romantic/gone.jpg" alt="" /></a>
            <div class="product-info">
              <h3>GONE WITH THE WIND</h3>
              <div class="product-desc">
                <h4>MARGARET MITCHELL</h4>
                <p>GONE WITH THE WIND<br />	
                </p>
                <strong class="price">Rs.699.00</strong> </div>
            </div>
          </li>
		    <li class="last"> <a href="#"><img src="css/images/Romantic/lord.jpg" alt="" /></a>
            <div class="product-info">
              <h3>LORD OF SCOUNDRELS</h3>
              <div class="product-desc">
                <h4>LORETTA CHASE'S</h4>
                <p>LORD OF SCOUNDRELS<br />
                </p>
                <strong class="price">Rs.389.00</strong> </div>
            </div>
          </li>
		   <li> <a href="#"><img src="css/images/Romantic/lover.jpg" alt="" /></a>
            <div class="product-info">
              <h3>LOVER AWAKENED</h3>
              <div class="product-desc">
                <h4>J.R.WARD'S</h4>
                <p>LOVER AWAKENED<br />	
                </p>
		   ...
		   <li> <a href="#"><img src="css/images/Romantic/naked.jpg" alt="" /></a>
            <div class="product-info">
              <h3>NAKED IN DEATH</h3>
              <div class="product-desc">
                <h4>J.D. ROBB'S</h4>
                <p>NAKED IN DEATH<br />	
                </p>
		    ...
		    <li class="last"> <a href="#"><img src="css/images/Romantic/viscount.jpg" alt="" /></a>
            <div class="product-info">
              <h3>THE VISCOUNT WHO LOVED ME</h3>
              <div class="product-desc">
                <h4>JULIA QUINN'S</h4>
                <p>THE VISCOUNT WHO LOVED ME<br />
                </p>
                <strong class="price">Rs.499.00</strong> </div>
            </div>
          </li>
