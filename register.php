...
function validateForm() {
   ...
   function checkEmail() {
    ...
    var email = document.forms["myForm"]["e_mail1"].value;
...
<link rel="stylesheet" href="css/styleregister.css" type="text/css" media="all" />
...
?></strong></span> </div>
  ...
  <body>
<?php
if(isset($_SESSION['currentuser'])){echo"you are already logged in <a href='index.php'>continue shooping</a>";}
else{echo'
    <div class="login-card">
    <h1>Register</h1><br>
  <form action="test2.php" name="myForm" method="post" onsubmit="return validateForm()">
    <input type="text" name="user" placeholder="Username">
    <input type="password" name="pass" placeholder="Password">
	<input type="other" name="e_mail1" placeholder="E-Mail">
	<input type="other" name="mobile" placeholder="Mobile Number">
	<input type="other" name="ADDRESS" placeholder="Address">
