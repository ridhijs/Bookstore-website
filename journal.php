...
<div class="shell">
  <!-- Header -->
  <div id="header" style="left: -10px; top: -10px">
...
?></strong></span> </div>
  ...
  <div id="main">
    ...
    <div id="content">
	  ...
	  <!-- Products -->
      <div class="products">
	  <h1>BESTSELLER JOURNALS</h1><br/>
        <div class="cl">&nbsp;</div>
        <ul>
          <li> <a href="#"><img src="css/images/Journals/chemical.jpg" alt="" /></a>
            <div class="product-info">
              <h3>JOURNAL OF CHEMICAL EDUCATION</h3>
              <div class="product-desc">
                <h4>AMERICAN CHEMICAL SOCIETY'S</h4>
                <p>THE JOURNAL OF CHEMICAL EDUCATION<br />
                 </p>
                <strong class="price">Rs.499.00</strong> </div>
            </div>
          </li>
          <li> <a href="#"><img src="css/images/Journals/computer.jpg" alt="" /></a>
            <div class="product-info">
              <h3>INTERNATIONAL JOURNAL ON COMPUTER & NETWORK SOLUTIONS</h3>
              <div class="product-desc">
                <h4>H. MEHDI'S</h4>
                <p>INTERNATIONAL JOURNAL ON COMPUTER & NETWORK SOLUTIONS<br />	
                </p>
                <strong class="price">Rs.999.00</strong> </div>
            </div>
          </li>
          <li class="last"> <a href="#"><img src="css/images/Journals/international.jpg" alt="" /></a>
            <div class="product-info">
              <h3>INTERNATIONAL JOURNAL ON SOCIAL SCIENCES REVIEW </h3>
              <div class="product-desc">
                <h4>SUNIL SAINI'S</h4>
                <p>INTERNATIONAL JOURNAL ON SOCIAL SCIENCES REVIEW<br />
                </p>
		...
		<ul>
		 <li> <a href="#"><img src="css/images/Journals/yale.jpg" alt="" /></a>
            <div class="product-info">
              <h3>YALE JOURNAL OF BIOLOGY & MEDICINE</h3>
              <div class="product-desc">
                <h4>YALE JORNALS PUBLICATION'S</h4>
                <p>YALE JOURNAL OF BIOLOGY & MEDICINE<br />	
                </p>
                <strong class="price">Rs.999.00</strong> </div>
            </div>
          </li>
		   <li> <a href="#"><img src="css/images/Journals/cleopatra.jpg" alt="" /></a>
            <div class="product-info">
		    ...
		    <li class="last"> <a href="#"><img src="css/images/Journals/johnadmas.jpg" alt="" /></a>
            <div class="product-info">
              <h3>JOHN ADAMS</h3>
              <div class="product-desc">
		   ...
		   <li> <a href="#"><img src="css/images/Journals/malala.jpg" alt="" /></a>
            <div class="product-info">
              <h3>I AM MALALA</h3>
              <div class="product-desc">
		   ...
		   <li> <a href="#"><img src="css/images/Journals/stevejobs.jpg" alt="" /></a>
            <div class="product-info">
              <h3>STEVE JOBS</h3>
              <div class="product-desc">
		    ...
		    <li class="last"> <a href="#"><img src="css/images/Journals/teamofrivals.jpg" alt="" /></a>
            <div class="product-info">
