...
function display($dynamic_var1,$dynamic_var2,$dynamic_var3,$dynamic_var4,$num3){
	if($num3/2!=0  ){ 
		echo'<li class="last">
		  ...
		  <a href="#"><img src="'. $dynamic_var4.'" alt="" /></a>
            <div class="product-info">
              ...
              <div class="product-desc">
                ...
                <p>'.$dynamic_var1.'<br /></p>
                <strong class="price">'.$dynamic_var3.'</strong>
				<p><a href="cart_update.php"><button  >add to cart</button></a></p>	
				</div>
            	</div></li>';
	}	
...
while ($num3<$row2)
    {    
	  ...
	  display($dynamic_var1,$dynamic_var2,$dynamic_var3,$dynamic_var4,$num3);
	//$pro_id=$dynamic_var1;
 $GLOBALS['count']++;$num3++;
  ...
  <div id="footer">
    ...
    <p class="right"> &copy; 2015 The BookStore. Design by Ridhi Shah</a> </p>
  </div>
  <!-- End Footer -->
</div>
<!-- End Shell -->
